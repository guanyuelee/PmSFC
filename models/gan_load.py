...
def make_biggan_config(config_path, weights_root):
...
def make_unconditioned_big_gan(config_path, weights_root):
    config = make_biggan_config(config_path, weights_root)
...
@gan_with_shift
def make_conditioned_big_gan(weights_root, target_class):
